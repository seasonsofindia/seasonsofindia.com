...
export const Contact = () => {
  ...
  // Reduced top padding so this sits closer to the Menu section above
  <section id="contact" className="pt-6 pb-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Visit us for an authentic Indian dining experience or get in touch for reservations, catering, or other inquiries.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">7085 S Orange Blossom Trail<br/>Orlando, FL 32805</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                <a href="tel:407-203-8552" className="hover:underline">(407) 203-8552</a><br/>
                <a href="tel:689-242-4441" className="hover:underline">(689) 242-4441</a>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Mon - Sun<br/>11:00 AM - 10:00 PM</p>
            </CardContent>
          </Card>
        ...
        {/* Responsive button group: stacked on xs, side-by-side from sm and up */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button asChild size="lg" className="w-full sm:w-auto bg-restaurant-primary hover:bg-restaurant-primary/90 text-white text-lg px-8 py-4">
            <a href="tel:407-203-8552" className="flex items-center justify-center gap-2">
          ...
          <Button asChild size="lg" className="w-full sm:w-auto bg-restaurant-primary hover:bg-restaurant-primary/90 text-white text-lg px-8 py-4">
            <a href="tel:689-242-4441" className="flex items-center justify-center gap-2">
              <Phone className="h-5 w-5 text-white" />
              <span>Catering</span>
            </a>
          </Button>
